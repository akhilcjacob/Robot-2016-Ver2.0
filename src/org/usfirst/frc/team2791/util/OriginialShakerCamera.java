...
import static org.usfirst.frc.team2791.robot.Robot.visionShot;

import java.util.ArrayList;
import java.util.TreeMap;
import java.util.concurrent.Semaphore;

public class OriginialShakerCamera implements Runnable {
	private static OriginialShakerCamera cameraInstance;
	...
	private OriginialShakerCamera(String camPort) {
	...
	public static OriginialShakerCamera getInstance() {
		if (cameraInstance == null)
			cameraInstance = new OriginialShakerCamera("cam2");
