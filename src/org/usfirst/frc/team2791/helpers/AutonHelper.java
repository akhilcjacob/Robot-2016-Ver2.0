 ...
 * This is the class that selects the auton and runs it accordingly
 */
public class AutonHelper extends ShakerHelper {
    ...
    private static void retuneStationaryAnglePID() {
        driveTrain.setAngle(SmartDashboard.getNumber("Angle setpoint"), SmartDashboard.getNumber("max speed"), true, true);
    }
