//This was the code that worked at competition, I cleaned it up so it makes sense
//but I probably messed up on the cleanup so this is here for reference when things go south
